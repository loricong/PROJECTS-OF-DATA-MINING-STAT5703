...
audit <- read.csv("~/Desktop/GRADUATE/5703/Jiaming Han-Yuhua Cong-Jingyi Chen-STAT 5703 Final Project Report/Data/audit.csv", stringsAsFactors=FALSE)
View(audit)
...
#For those who don’t have any forms of college education, less than 20% have a productive audit. 
...
ta_pred_caret<-train(trainknn,TARGET_Adjusted_train,method="knn",preProcess = c("center","scale"))
